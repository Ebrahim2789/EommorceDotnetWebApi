...
namespace Ecommorce.API.Migrations
{
    ...
    [Migration("20250217164452_productCatgory")]
    partial class productCatgory
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ecommorce.Model.ProductModels.ProductPublish", b =>
                {
                    ...
                    b.HasKey("ProductID", "PublisherId", "UserId");
            ...
            modelBuilder.Entity("Ecommorce.Model.ProductModels.PublisherUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Ecommorce.Model.ProductModels.Product", b =>
                {
                    ...
                    b.HasOne("Ecommorce.Model.ProductModels.ProductVariation", "Variations")
                        .WithMany()
            ...
            modelBuilder.Entity("Ecommorce.Model.ProductModels.ProductPublish", b =>
                {
                    ...
                    b.HasOne("Ecommorce.Model.ProductModels.PublisherUser", "PublisherUser")
                        .WithMany("ProductPublishers")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
